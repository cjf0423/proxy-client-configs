...
ps：此为CenBoMin的脚本，因只有quanx，此处换为Surge的模块
...
【1.一般版-模块引用】:https://raw.githubusercontent.com/cjf0423/proxy-client-configs/main/surge/scripts/shuqi/cookie.sgmodule
【2.极速版-模块引用】:https://raw.githubusercontent.com/cjf0423/proxy-client-configs/main/surge/scripts/shuqi/spcookie.sgmodule
【3.一般版-福利转转转-模块引用】:https://raw.githubusercontent.com/cjf0423/proxy-client-configs/main/surge/scripts/shuqi/lottery.sgmodule
【4.极速版-刷时长-模块引用】:https://raw.githubusercontent.com/cjf0423/proxy-client-configs/main/surge/scripts/shuqi/everday.sgmodule

//食用方法：

📌温馨提示1:启动模块引用获取cookie时务必要确认重写引用是不是生效(Surge点配置文件-外部资源-全部更新)，通常会因为raw连接需要代理而出错，所以启用更新的时候不要用直连模式！

📌温馨提示2:视频加载出错,采用全部直连模式！

📌请先添加以上四个模块引用，在依照以下说明依序获取cookie。。。

📌非常重要！非常重要！非常重要！:
每次只可以启用一个模块引用sgmodule,获取完cookie,务必关闭当前模块引用sgmodule!在启用下一个模块引用sgmodule。否则cookie抓取会出错,导致脚本执行错误，4个模块引用,绝对不可以同时开启两个，只可以一个！！！！！！！⭐️是也许获取会发生问题的,特别注意说明！！获取不到或者出错的,参照最底下的BOXJS对照表重新获取

1.一般版本,请添加模块获取cookie：https://raw.githubusercontent.com/cjf0423/proxy-client-configs/main/surge/scripts/shuqi/cookie.sgmodule
...
2.极速版本,请添加模块获取cookie：https://raw.githubusercontent.com/cjf0423/proxy-client-configs/main/surge/scripts/shuqi/spcookie.sgmodule
...
3.一般版本-福利转转转，极速版本-浏览书城，极速版本-签到页面看视频,请添加模块获取cookie：https://raw.githubusercontent.com/cjf0423/proxy-client-configs/main/surge/scripts/shuqi/lottery.sgmodule
...
4.极速版-刷时长，请添加模块获取cookie：https://raw.githubusercontent.com/cjf0423/proxy-client-configs/main/surge/scripts/shuqi/everday.sgmodule
